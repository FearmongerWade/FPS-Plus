...
class Scoring
{
    public static var SICK_HEAL_AMMOUNT:Float = (1.5 / 100) * 2;
    public static var GOOD_HEAL_AMMOUNT:Float = (0.75 / 100) * 2;
    public static var BAD_HEAL_AMMOUNT:Float = (0 / 100) * 2;
    public static var SHIT_HEAL_AMMOUNT:Float = (-1 / 100) * 2;
    public static var HOLD_HEAL_AMMOUNT:Float = (0.5 / 100) * 2;

    public static var MISS_DAMAGE_AMMOUNT:Float = (4 / 100) * 2;
